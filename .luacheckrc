...
globals = {
	...
	-- TODO - those needs to be updated, does not exist in 548
	...
	"ActionButton_UpdateLossOfControlCooldown",
	...
	"AlertFrame_SetLootAnchors",
	"AlertFrame_SetStorePurchaseAnchors",
	"AlertFrame_SetLootWonAnchors",
	"AlertFrame_SetMoneyWonAnchors",
	"AlertFrame_SetAchievementAnchors",
	"AlertFrame_SetCriteriaAnchors",
	"AlertFrame_SetChallengeModeAnchors",
	"AlertFrame_SetDungeonCompletionAnchors",
	"AlertFrame_SetScenarioAnchors",
	"AlertFrame_SetGuildChallengeAnchors",
	"AlertFrame_SetDigsiteCompleteToastFrameAnchors",
	...
	"ChallengeModeAlertFrameReward_SetReward",
	"ChallengeModeAlertFrameReward_OnEnter",
	"ChallengeModeAlertFrameReward_OnLeave",
	"AchievementAlertFrame_OnLoad",
	"AchievementAlertFrame_IsPaused",
	"AchievementAlertFrame_FireDelayedAlerts",
	"AchievementAlertFrame_ShowAlert",
	"AchievementAlertFrame_GetAlertFrame",
	"CriteriaAlertFrame_ShowAlert",
	"CriteriaAlertFrame_GetAlertFrame",
	"AchievementAlertFrame_OnClick",
	"LootWonAlertFrame_ShowAlert",
	"LootWonAlertFrame_SetUp",
	"MoneyWonAlertFrame_ShowAlert",
	"MoneyWonAlertFrame_SetUp",
	"DigsiteCompleteToastFrame_ShowAlert",
	...
	-- Blizzard_AchievementUI\Blizzard_AchievementUI.lua
	...
	-- Blizzard_AchievementUI\Localization.lua
	...
	-- Blizzard_ArchaeologyUI\Blizzard_ArchaeologyProgressBar.lua
	...
	-- Blizzard_ArchaeologyUI\Blizzard_ArchaeologyUI.lua
	...
	-- Blizzard_AuctionUI\Blizzard_AuctionUI.lua
	"AuctionFrame_OnLoad",
	"AuctionFrame_Show",
	"AuctionFrame_Hide",
	"AuctionFrame_OnShow",
	...
	-- Blizzard_BattlefieldMinimap\Blizzard_BattlefieldMinimap.lua
	...
	-- Blizzard_BlackMarketUI\Blizzard_BlackMarketUI.lua
	...
	"BlackMarket_RarityDropDown_OnLoad",
	"BlackMarket_RarityDropDown_Initialize",
	"BlackMarket_RarityDropDown_OnClick",
	...
	"ChallengesFrameLeaderboard_OnClick",
	"ChallengesFrameGuild_OnEnter",
	"ChallengesFrameRealm_OnEnter",
	-- Blizzard_CombatLog\Blizzard_CombatLog.lua
	...
	-- Blizzard_CombatText\Blizzard_CombatText.lua
	"CombatText_OnLoad",
	"CombatText_OnEvent",
	"CombatText_OnUpdate",
	...
	-- Blizzard_CompactRaidFrames\Blizzard_CompactRaidFrameContainer.lua
	...
	"CRF_CountStuff",
	"CRF_AddToCount",
	-- Blizzard_CompactRaidFrames\Blizzard_CompactRaidFrameReservationManager.lua
	...
	-- Blizzard_DebugTools\Blizzard_DebugTools.lua
	...
	"EncounterJournal_OnSearchTextChanged",
	...
	"EJNAV_ListEncounter",
	-- Blizzard_GlyphUI\Blizzard_GlyphUI.lua
	"GlyphFrame_Toggle",
	"GlyphFrame_Open",
	"GlyphFrame_OnLoad",
	"GlyphFrame_OnShow",
	...
	-- Blizzard_GMChatUI\Blizzard_GMChatUI.lua
	"GMChatFrame_IsGM",
	"GMChatFrame_OnLoad",
	"GMChatFrame_OnEvent",
	"GMChatFrame_OnShow",
	...
	-- Blizzard_GMSurveyUI\Blizzard_GMSurveyUI.lua
	...
	-- Blizzard_GuildBankUI\Blizzard_GuildBankUI.lua
	...
	-- Blizzard_GuildControlUI\Blizzard_GuildControlUI.lua
	...
	-- Blizzard_GuildUI\Blizzard_GuildInfo.lua
	...
	-- Blizzard_GuildUI\Blizzard_GuildNews.lua
	...
	-- Blizzard_GuildUI\Blizzard_GuildRewards.lua
	...
	-- Blizzard_GuildUI\Blizzard_GuildUI.lua
	"GuildFrame_OnLoad",
	"GuildFrame_OnShow",
	"GuildFrame_OnHide",
	"GuildFrame_Toggle",
	...
	"GuildMainFrame_OnLoad",
	"GuildMainFrame_OnShow",
	"GuildMainFrame_OnEvent",
	"GuildMainFrame_UpdateNewsEvents",
	"GuildMainFrame_SetNewsOrEventButton",
	"GuildEventButton_OnClick",
	"GuildPerksButton_OnEnter",
	"GuildMainFrame_UpdatePerks",
	"GuildPerks_Update",
	"GuildPerksToggleButton_OnClick",
	...
	-- Blizzard_InspectUI\InspectGuildFrame.lua
	...
	-- Blizzard_ItemAlterationUI\Blizzard_ItemAlterationUI.lua
	"TransmogrifyFrame_Show",
	"TransmogrifyFrame_Hide",
	"TransmogrifyFrame_OnLoad",
	"TransmogrifyFrame_OnEvent",
	"TransmogrifyFrame_OnShow",
	"TransmogrifyFrame_OnHide",
	"TransmogrifyFrame_GetAnimationFrame",
	"TransmogrifyFrame_GetPendingFrame",
	"TransmogrifyFrame_AnimateSlotButton",
	"TransmogrifySlotButton_OnLoad",
	"TransmogrifySlotButton_OnEvent",
	"TransmogrifySlotButton_OnClick",
	"TransmogrifySlotButton_OnEnter",
	"TransmogrifySlotButton_OnLeave",
	"TransmogrifyFrame_Update",
	"TransmogrifyFrame_UpdateApplyButton",
	"TransmogrifyFrame_UpdateSlotButton",
	"TransmogrifyItemFlyoutButton_OnClick",
	"TransmogrifyItemFlyout_GetItems",
	"TransmogrifyConfirmationPopup_Show",
	"TransmogrifyConfirmationPopup_SetItem",
	"TransmogrifyFrame_CloseFlyout",
	"TransmogrifySlotFlyoutButton_OnUpdate",
	-- Blizzard_ItemSocketingUI\Blizzard_ItemSocketingUI.lua
	...
	-- Blizzard_ItemUpgradeUI\Blizzard_ItemUpgradeUI.lua
	...
	-- Blizzard_MacroUI\Blizzard_MacroUI.lua
	"MacroFrame_Show",
	"MacroFrame_OnLoad",
	"MacroFrame_OnShow",
	"MacroFrame_OnHide",
	...
	-- Blizzard_PetBattleUI\Blizzard_PetBattleUI.lua
	...
	-- Blizzard_PetJournal\Blizzard_PetJournal.lua
	"PetJournalUtil_GetDisplayName",
	"PetJournalParent_SetTab",
	"PetJournalParent_UpdateSelectedTab",
	"PetJournalParent_OnShow",
	"PetJournalParent_OnHide",
	"PetJournal_OnLoad",
	"PetJournal_OnShow",
	"PetJournal_OnHide",
	"PetJournal_OnEvent",
	...
	"MountJournal_OnShow",
	"MountJournal_DirtyList",
	"MountJournal_UpdateCachedList",
	"MountJournal_MountMatchesFilter",
	"MountJournal_UpdateMountList",
	"MountJournalMountButton_UpdateTooltip",
	"MountJournal_UpdateMountDisplay",
	"MountJournal_FindSelectedIndex",
	"MountJournal_Select",
	"MountJournal_GetSelectedSpellID",
	"MountJournalMountButton_OnClick",
	"MountListDragButton_OnClick",
	"MountListItem_OnClick",
	"MountJournal_OnSearchTextChanged",
	-- Blizzard_PVPUI\Blizzard_PVPUI.lua
	"PVPUIFrame_OnLoad",
	"PVPUIFrame_OnShow",
	"PVPUIFrame_OnHide",
	"PVPUIFrame_OnEvent",
	...
	-- Blizzard_QuestChoice\Blizzard_QuestChoice.lua
	...
	-- Blizzard_ReforgingUI\Blizzard_ReforgingUI.lua
	"ReforgingFrame_Show",
	"ReforgingFrame_Hide",
	...
	"StoreProductCard_UpdateState",
	"StoreProductCard_UpdateAllStates",
	"StoreProductCard_OnEnter",
	"StoreProductCard_OnLeave",
	"StoreProductCard_OnClick",
	"StoreProductCard_OnLoad",
	"StoreProductCardModel_RotateLeft",
	"StoreProductCardModel_RotateRight",
	"StoreProductCardModel_OnUpdate",
	"StoreProductCard_OnDragStart",
	"StoreProductCard_OnDragStop",
	"StoreProductCard_ModelOnEvent",
	"StoreProductCard_SetModel",
	"StoreProductCard_ShowIcon",
	"StoreProductCard_IsSplashPage",
	"StoreProductCard_ShowDiscount",
	"StoreProductCardMagnifyingGlass_OnEnter",
	"StoreProductCardMagnifyingGlass_OnLeave",
	"StoreProductCardMagnifyingGlass_OnClick",
	"StoreProductCardCheckmark_OnEnter",
	"StoreProductCardCheckmark_OnLeave",
	"StoreProductCard_ResetCornerPieces",
	...
	-- Blizzard_TalentUI\Blizzard_TalentUI.lua
	...
	-- Blizzard_TimeManager\Blizzard_TimeManager.lua
	"TimeManager_Toggle",
	...
	-- Blizzard_TokenUI\Blizzard_TokenUI.lua
	"TokenButton_OnLoad",
	"TokenFrame_OnLoad",
	"TokenFrame_OnShow",
	"TokenFrame_Update",
	...
	-- Blizzard_TradeSkillUI\Blizzard_TradeSkillUI.lua
	...
	"TradeSkillSetFilter",
	"TradeSkillFilterDropDown_Initialize",
	"TradeSkillFrameIncrement_OnClick",
	"TradeSkillFrameDecrement_OnClick",
	"TradeSkillItem_OnEnter",
	"TradeSkillFrame_PlaytimeUpdate",
	"TradeSkillLinkDropDown_LinkPost",
	"TradeSkillLinkDropDown_OnLoad",
	"TradeSkillLinkDropDown_Init",
	"TradeSkillViewGuildCraftersButton_OnClick",
	"TradeSkillGuildFrame_OnShow",
	"TradeSkillGuildCraftersFrame_Update",
	"TradeSkillRetrievingFrame_OnUpdate",
	-- Blizzard_TrainerUI\Blizzard_TrainerUI.lua
	...
	-- Blizzard_VoidStorageUI\Blizzard_VoidStorageUI.lua
	...
	"TimeAlert_Close",
	"TimeAlert_OnUpdate",
	"BNet_ShouldProcessOfflineEvents",
	...
	"BuffButton_OnLoad",
	"BuffButton_OnClick",
	"ConsolidatedBuffButton_OnClick",
	...
	-- FlexRaidFrame.lua
	"FlexRaidFrame_OnLoad",
	"FlexRaidFrame_OnEvent",
	"FlexRaidFrame_OnShow",
	"FlexRaidFrame_ShowBest",
	"FlexRaidFrame_Update",
	"FlexRaidFrame_UpdateAvailability",
	"FlexRaidFrame_UpdateButton",
	"FlexRaidFrameSelectionDropDown_SetUp",
	"FlexRaidFrameSelectionDropDown_Initialize",
	"FlexRaidFrameSelectionDropDown_OnClick",
	"FlexRaidFrame_SetRaid",
	"FlexRaidFrame_Join",
	...
	"PET_BATTLE_FLOATING_ABILITY_TOOLTIP",
	...
	"CanGroupWithAccount",
	"FriendsFrame_HasInvitePermission",
	...
	"IconIntroTracker_OnLoad",
	"IconIntroTracker_OnEvent",
	...
	"InterfaceOptionsLossOfControl_OnEvent",
	"InterfaceOptionsLossOfControlDropDown_SetValue",
	"InterfaceOptionsLossOfControlDropDown_GetValue",
	"InterfaceOptionsLossOfControlDropDown_RefreshValue",
	"InterfaceOptionsLossOfControl_SetUpDropdown",
	"InterfaceOptionsLossOfControlDropDown_OnClick",
	"InterfaceOptionsLossOfControlDropDown_Initialize",
	...
	"InterfaceOptionsSocialPanelBnWhisperMode_OnEvent",
	...
	"MissingLootFrame_OnHide",
	"MissingLootItem_OnEnter",
	...
	"MacOptionsFrameResolutionDropDown_UpdateSelection",
	"MacOptionsFrameResolutionDropDown_OnLoad",
	"MacOptionsFrameResolutionDropDown_OnShow",
	"MacOptionsFrameResolutionDropDown_OnEvent",
	...
	-- MonkHarmonyBar.lua
	"MonkHarmonyBar_SetEnergy",
	"MonkHarmonyBar_Update",
	"MonkHarmonyBar_OnLoad",
	"MonkHarmonyBar_OnEvent",
	-- MonkStaggerBar.lua
	...
	-- ShardBar.lua
	"WarlockPowerFrame_OnLoad",
	"WarlockPowerFrame_OnEvent",
	"WarlockPowerFrame_SetUpCurrentPower",
	"WarlockPowerFrame_UpdateFill",
	"WarlockPowerFrame_OnUpdate",
	"ShardBar_SetShard",
	"ShardBar_Update",
	"DemonicFuryBar_Update",
	"DemonicFuryBar_SetPower",
	"DemonicFuryBar_CheckAndSetState",
	"DemonicFuryBar_CheckStatusCVars",
	"BurningEmbersBar_Update",
	"BurningEmbersBar_SetPower",
	...
	"SpellBookCoreAbilitiesTab_OnClick",
	...
	"SerachBoxTemplate_OnEditFocusGained",
	"BagSearch_OnHide",
	"BagSearch_OnTextChanged",
	"BagSearch_OnChar",
	"BagSearch_OnEditFocusGained",
	"BagSearch_OnEditFocusLost",
	...
	"WatchFrameAutoQuest_OnFinishSlideIn",
	...
	"ArchaeologyDigSiteFrame_OnUpdate",
	...
	"WorldMapShowDropDown_OnLoad",
	"WorldMapShowDropDown_Initialize",
	"WorldMapShowDropDown_OnClick",
	-- WorldStateFrame.lua
	...
	"ACHIEVEMENT_ID_INDEX",
	"OLD_ACHIEVEMENT_INDEX",
	"MAX_QUEUED_ACHIEVEMENT_TOASTS",
	"DUNGEON_COMPLETION_MAX_REWARDS",
	"CHALLENGE_MODE_MAX_REWARDS",
	"SCENARIO_MAX_REWARDS",
	-- AlternatePowerBar.lua
	...
	-- Blizzard_Calendar\Localization.lua
	"CALENDAR_FIRST_WEEKDAY",
	-- Blizzard_CombatLog\Blizzard_CombatLog.lua
	...
	"DT",
	-- Blizzard_EncounterJournal\Blizzard_EncounterJournal.lua
	"EJ_MIN_CHARACTER_SEARCH",
	"EJ_Tabs",
	-- Blizzard_GlyphUI\Blizzard_GlyphUI.lua
	"GLYPH_STRING",
	"GLYPH_STRING_PLURAL",
	"GLYPH_HEADER_BUTTON_HEIGHT",
	"GLYPH_BUTTON_HEIGHT",
	"GLYPH_BUTTON_OFFSET",
	"GLYPH_FILTER_KNOWN",
	"GLYPH_FILTER_UNKNOWN",
	"GLYPH_TYPE_INFO",
	-- Blizzard_GMSurveyUI\Blizzard_GMSurveyUI.lua
	"MAX_RADIO_BUTTONS",
	...
	"BOOKTYPE_PROFESSION",
	"BOOKTYPE_PET",
	"BOOKTYPE_CORE_ABILITIES",
	"BOOKTYPE_WHAT_HAS_CHANGED",
	"SpellBookInfo",
